...
import { models, ModelName, ModelStructure, ModelScalarFields, AnyRecord, BaseOption, Find, CountArgs, Aggregate, ModelTypes } from './models';
...
>(modelName: T) => {
  abstract class AbstractBaseRepository {
    ...
    public static async findAll(
      ...
      const where = { ...AbstractBaseRepository.extractCondition(conditions), ...filterQueryParams, ...otherOptions };
    ...
    public static async bulkCreate(data: Prisma.Enumerable<Create>, skipDuplicates = true) {
      // @ts-ignore
      return AbstractBaseRepository.model.createMany({ data, skipDuplicates }) as Promise<Prisma.BatchPayload>;
    }

    public static async bulkUpdate(where: Where, data: Prisma.Enumerable<Update>) {
      // @ts-ignore
      return AbstractBaseRepository.model.updateMany({ data, where }) as Promise<Prisma.BatchPayload>;
    }
